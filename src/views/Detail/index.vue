...
<template>
  <div class="xtx-goods-page">
    <div class="container">
      <div class="bread-container" v-if="detail.categories">
        ...
        <div>
          <div class="goods-info">
            ...
            <div class="spec">
              ...
              <!-- sku组件 -->
              <XtxSku :goods="detail" @change="changeSku" />
              <!-- 数据组件 -->
               <el-input-number v-model="count" @change="changeCount"/>
              <!-- 按钮组件 -->
              <div>
                <el-button size="large" class="btn" @click="addCarList">
                  加入购物车
                </el-button>
              </div>
            ...
            <div class="goods-article">
              ...
              <div class="goods-tabs">
                ...
                <div class="goods-detail">
                  <!-- 属性 -->
                  <ul class="attrs">
                    <li v-for="item in detail.properties" :key="item.value">
